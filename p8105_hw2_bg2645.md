...
There were 344 observations and 14 variables in the `trashwheel`
dataset. The key variables in this dataset are the types of litter that
is collected by mr. trash wheel nd the amount of such litter.
...
| \*table sh | owing the most popular name a | mong male children o | ver tim |    e |      |      |      |      |
...
| \*produce | a scatter plot showing the nu | mber of | children | with a n | ame (y ax | is) again | st the ra | nk in popularity of that name (x axis), for male, white non-hispanic children born in 2016 |
