...
There were `r nrow(trashwheel_data)` observations and `r ncol(trashwheel_data)` variables in the `trashwheel` dataset. The key variables in this dataset are the types of litter that is collected by mr. trash wheel nd the amount of such litter. 
